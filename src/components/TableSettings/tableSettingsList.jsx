...
export default function SettingsList({settings, setSettings, onResetProgress, preset, setPreset})
{
    ...
    return(
        ...
        <div className = "generalWarning"><label>* - These settings are not available on Archipelago, but are included to cater to vanilla gameplay. Refer to the non vanilla presets for the correct randomizer settings. I'm sorry if this is confusing, this will be fixed in the next update!</label></div>
            ...
            <div className = "allSmallSettingBlocks">
                <div className = "smallSettingBlock">
                    ...
                    <div className = "smallSettingBlock">
                        <div className = "settingTitle"><label><strong>Major Unlocks</strong></label></div>
                            <div className = "smallSettings">
                                ...
                                <label>Start Without Backpack? <input type="checkbox" checked={excludeBackpack} onChange={() => updateFilter("excludeBackpack", prev => !prev)} /></label>
        ...
        <div className = "allBigSettingBlocks">
            <div className = "bigSettingBlock">
                <div className = "settingTitle"><label><strong>Extra Shuffling</strong></label></div>
                    <div className = "bigSettings">
            ...
            <div className = "bigSettingBlock">
                <div className = "settingTitle"><label><strong>Extreme Options</strong></label></div>
                    <div className = "bigSettings">
